					...
					<ul class="nav nav-pills" style="background-color:black">
						...
						<li class="dropdown pull-right" style="width:300px">
							...
							<ul class="dropdown-menu">
								<form class="form-horizontal" role="form" action="Loginmenu.html">
					...
					<div class="row clearfix">
						...
						<div class="col-md-6 column">
							<form role="form" action="RegisterServlet" method="get">
								<div class="form-group">
									 <label for="exampleInputEmail1">NPM</label><input class="form-control" id="exampleInputEmail1" type="text" name="inputnpm"/>
								</div>
								<div class="form-group">
									 <label for="exampleInputEmail1">Username</label><input class="form-control" id="exampleInputEmail1" type="name" name="inputusername"/>
								</div>
								<div class="form-group">
									 <label for="exampleInputPassword1">Password</label><input class="form-control" id="exampleInputPassword1" type="password" name="inputpassword"/>
								</div>
