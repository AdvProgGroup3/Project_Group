					...
					<div class="row clearfix" style="margin-top:10px">
						...
						<div class="col-md-6 column">
							<div class="list-group">
								...
								<br>
								<br>
								<h2>Your Area ID is :</h2>
								<br>
								<br>
								<h1>${areaId}</h1>
								<br>
								<br>
								<form action="BookingCancel" method="get">
									<button class="btn btn-danger" name="areaId" value="<%=request.getAttribute("areaId") %>">Cancel Booking</button>
								</form>
								<br>
								<br>
